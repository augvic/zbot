...
class Api:
    ...
    def __init__(self, engines: Engines, tasks: Tasks, threads: Threads) -> None:
        ...
        self.registrations_rpa_route = RegistrationsRpaRoute(threads=self.threads, engines=self.engines)
