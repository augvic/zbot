...
class StateRegistrationsClient:
    ...
    def __init__(self, db: str):
        try:
            ...
            raise Exception(f"Error on (StateRegistrationsClient) component on (__init__) method: {error}")
    ...
    def create(self,
        ...
        try:
            ...
            raise Exception(f"Error on (StateRegistrationsClient) component on (create) method: {error}")
    ...
    def read_all(self, cnpj: str) -> list[StateRegistration]:
        try:
            ...
            raise Exception(f"Error on (StateRegistrationsClient) component on (read_all) method: {error}")
    ...
    def delete(self, cnpj: str) -> None:
        try:
            ...
            raise Exception(f"Error on (StateRegistrationsClient) component on (delete) method: {error}")
