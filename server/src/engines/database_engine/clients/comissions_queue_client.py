...
class ComissionsQueueClient:
    ...
    def create(self,
        ...
        try:
            ...
            raise Exception(f"❌ Error in (ComissionsQueueClient) engine in (create) method: {error}")
    ...
    def read(self, order: str) -> list[ComissionQueue]:
        try:
            ...
            raise Exception(f"❌ Error in (ComissionsQueueClient) engine in (read) method: {error}")
    ...
    def delete(self, order: str) -> None:
        try:
            ...
            raise Exception(f"❌ Error in (ComissionsQueueClient) engine in (delete) method: {error}")
