...
class ComissionsQueueClient:
    ...
    def create(self,
        ...
        try:
            ...
            raise Exception(f"❌ Error in (ComissionsQueueClient) in (create) method: {error}")
    ...
    def read(self, order: str) -> list[ComissionQueue]:
        try:
            ...
            raise Exception(f"❌ Error in (ComissionsQueueClient) in (read) method: {error}")
    ...
    def delete(self, order: str) -> None:
        try:
            ...
            raise Exception(f"❌ Error in (ComissionsQueueClient) in (delete) method: {error}")
