...
class PermissionsClient:
    ...
    def create(self, user: str, module: str) -> None:
        try:
            ...
            raise Exception(f"Error in (PermissionsClient) module in (create) method: {error}")
    ...
    def read_all_from_user(self, user: str) -> list[Permission]:
        try:
            ...
            raise Exception(f"Error in (PermissionsClient) module in (read_all_from _user) method: {error}")
    ...
    def delete_from_user(self, user: str, module: str) -> None:
        try:
            ...
            raise Exception(f"Error in (PermissionsClient) module in (delete_from_user) method: {error}")
    ...
    def delete_all(self, module: str) -> None:
        try:
            ...
            raise Exception(f"Error in (PermissionsClient) module in (delete_all) method: {error}")
