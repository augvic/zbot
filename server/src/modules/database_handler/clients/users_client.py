...
class UsersClient:
    ...
    def create(self, user: str, name: str, email: str, password: str) -> None:
        try:
            ...
            raise Exception(f"Error in (UsersClient) module in (create) method: {error}")
    ...
    def read(self, user: str) -> User | None:
        try:
            ...
            raise Exception(f"Error in (UsersClient) module in (read) method: {error}")
    ...
    def read_all(self) -> list[User]:
        try:
            ...
            raise Exception(f"Error in (UsersClient) module in (read_all) method: {error}")
    ...
    def update(self, user: str, name: str = "", email: str = "", password: str = "") -> None:
        try:
            ...
            raise Exception(f"Error in (UsersClient) module in (update) method: {error}")
    ...
    def delete(self, user: str) -> None:
        try:
            ...
            raise Exception(f"Error in (UsersClient) module in (delete) method: {error}")
