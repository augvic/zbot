...
class PermissionsClientDummy:
    ...
    def create(self, user: str, module: str) -> None:
        try:
            ...
            raise Exception(f"Error in (PermissionsClientDummy) module in (create) method: {error}")
    ...
    def read_all_from_user(self, user: str) -> list[PermissionDummy]:
        try:
            ...
            raise Exception(f"Error in (PermissionsClientDummy) module in (read_all_from_user) method: {error}")
    ...
    def delete_from_user(self, user: str, module: str) -> None:
        try:
            ...
            raise Exception(f"Error in (PermissionsClientDummy) module in (delete_from_user) method: {error}")
    ...
    def delete_all(self, module: str) -> None:
        try:
            ...
            raise Exception(f"Error in (PermissionsClientDummy) module in (delete_all) method: {error}")
