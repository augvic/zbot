...
class ModelSerializer:
    ...
    def serialize_dataclass(self, object: Any) -> dict[str, Any]:
        try:
            ...
            raise Exception(f"Error in (ModelSerializer) module in (serialize) method: {error}")
    ...
    def serialize_dataclass_list(self, objects: list[Any]) -> list[dict[str, Any]]:
        try:
            ...
            raise Exception(f"Error in (ModelSerializer) module in (serialize_list) method: {error}")
