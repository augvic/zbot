from src.backend.infrastructure.drivers.databases.production.clients import PermissionsClient
from src.backend.infrastructure.drivers.databases import Serializer
