from src.backend.infrastructure.drivers.sap_clients.errors import *
...
class SapGui:
    ...
    def set_selection_indexes(self, id: str, indexes: tuple) -> None:
        self.session.findById(id).setSelectionIndexes(*indexes)
    
    def select_item(self, id: str, indexes: tuple) -> None:
        self.session.findById(id).selectItem(*indexes)
    
    def ensure_visible_horizontal_item(self, id: str, indexes: tuple) -> None:
        self.session.findById(id).ensureVisibleHorizontalItem(*indexes)
    
    def double_click_item(self, id: str, indexes: tuple) -> None:
