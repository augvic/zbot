...
class Global {
    ...
    constructor() {
        ...
        this.themeButton = new elements.IconButton(themeButtonIcon);
...
class Zlogin {
    ...
    constructor() {
        ...
        this.label = new elements.Label("Login");
...
class Zindex {
    ...
    constructor() {
        ...
        this.menuButton = new elements.IconButton(menuButtonIcon);
        this.userName = new elements.Label("");
        this.logoutButton = new elements.IconButton("/storage/images/logout.png");
